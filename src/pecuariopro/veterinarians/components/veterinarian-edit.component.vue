...
<template>
  ...
  <pv-data-table
      ...
      :value="items"
      :globalFilterFields="['id', 'first_name', 'last_name', 'speciality', 'phone_number', 'city', 'status', 'photoUrl']"
      current-page-report-template="Showing {first} to {last} of {totalRecords} ${{title.plural}}"
      data-key="id"
      paginator-template="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink RowsPerPageDropdown">

    <template #empty> No Veterinarians found. </template>

    <template #loading> Loading Veterinarians data. Please wait. </template>
